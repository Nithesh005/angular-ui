...
import { ApexAxisChartSeries, ApexChart, ApexDataLabels, ApexFill, ApexLegend, ApexMarkers, ApexStroke, ApexTooltip, ApexXAxis, ApexYAxis, NgApexchartsModule, ApexAnnotations } from 'ng-apexcharts'
...
@Component({
  selector: 'app-style-01',
  standalone: true,
  imports: [NgFor, OptionsHorizComponent, ProgressChartComponent, NgApexchartsModule, NgClass, OptionsHorizComponent,TopBannerComponent],
...
export class Style01Component {
  ...
  public assetChartOptions!: ChartOptions
  times = [
